      RECURSIVE SUBROUTINE PDLAQR0m( WANTT, WANTZ, N, ILO, IHI, H,
...
*     .. Local Scalars ..
     ...
     $                   ELEM1, ELEM2, ELEM3
      INTEGER            I, J, INF, IT, ITMAX, K, KACC22, KBOT, KS,
     $                   KT, KTOP, KV, KWTOP, KWV, LD, LS, JW, TOTIT, 
     ...
     $                   WCOLS, HRSRC, HCSRC, NB, NPROCS, SWEEP, TOTNS,
     $                   IROFFH, ICOFFH, NWIN, MYROW_NEW, MYCOL_NEW,
     $                   LIWKOPT, NPMIN, ICTXT_NEW
...
*           Report progress
            CALL logPrint(
     $          "      Converged %.0lf eigenvalues at t[s]: %.2lf.@",
     $          DBLE(IHI-KBOT), .TRUE.)
